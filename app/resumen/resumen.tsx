              ...
              <div key={index} className="flex flex-col items-center">
                ...
                <div
                  className={`
                    ...
                    ${
                      day.completed
                        ? "bg-gradient-to-br from-red-500 via-red-600 to-black text-white"
